...
export default {
  setup() {
    ...
    const cityName = computed(() => store.state.openWeatherApi.cityName)
    const currentTemp = computed(() => store.state.openWeatherApi.currentWeather.currentTemp)
    const arrayTemps = computed(() => store.state.openWeatherApi.hourlyWeather)
    const images = computed(() => store.state.openWeatherApi.images)
