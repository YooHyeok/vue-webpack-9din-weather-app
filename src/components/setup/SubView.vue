...
import Map from '~/components/setup/Map.vue';
export default {
  components: {
    Map
  },
  setup() {
    ...
    const fetchOpenWeather = async () => {
      ...
      try {
        ...
        /* switch (true) {
          case feels_like <= 0: feeling.value = "매우 추움"
            break;
          case feels_like <= 10: feeling.value = "추움"
            break;
          case feels_like <= 15: feeling.value = "쌀쌀함"
            break;
          case feels_like <= 20: feeling.value = "신선함"
            break;
          case feels_like <= 25: feeling.value = "보통"
            break;
          case feels_like <= 30: feeling.value = "더움"
            break;
          case feels_like > 30: feeling.value = "매우 더움"
            break;
        } */
        ...
        let isPrcessedData = [
          { name: "일출시간", value: Unix_timestamp(sunrise) },
          { name: "일몰시간", value: Unix_timestamp(sunset) },
